...
package com.lan.nicehair.waterfall.base;
...
public class PLA_ListView extends PLA_AbsListView {
    ...
    private  int mSelectorColor=Color.TRANSPARENT;
    private int mCacheColorHint=Color.TRANSPARENT;
    ...
    public PLA_ListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectorColor=a.getColor(R.styleable.ListView_xlistSelector,Color.TRANSPARENT);
        mCacheColorHint=a.getColor(R.styleable.ListView_xcacheColorHint,Color.TRANSPARENT);
        a.recycle();
    }
    /**
